...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md p-5 hover:shadow-lg transition text-center">
            ...
            <a href="{{ route('lecturer.lhs.index') }}" class="text-sm text-blue-600 hover:underline">Lihat Detail</a>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-5 hover:shadow-lg transition text-center">
            ...
            <a href="{{ route('lecturer.smahaktif.index') }}" class="text-sm text-blue-600 hover:underline">Lihat Detail</a>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-5 hover:shadow-lg transition text-center">
            ...
            <a href="{{ route('lecturer.smatkul.index') }}" class="text-sm text-blue-600 hover:underline">Lihat Detail</a>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-5 hover:shadow-lg transition text-center">
            ...
            <a href="{{ route('lecturer.skl.index') }}" class="text-sm text-blue-600 hover:underline">Lihat Detail</a>
        </div>
    </div>
</div>
@endsection
